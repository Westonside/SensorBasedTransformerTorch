...
subDeviceCounts = ['nexus4_1', 'nexus4_2', 'lgwatch_1', 'lgwatch_2', 's3_1', 's3_2', 's3mini_1', 's3mini_2', 'gear_1',
                   'gear_2', 'samsungold_1', 'samsungold_2']
...
hkl.dump(finalData, 'datasetClientsUnion/' + dataName + '/clients_data.hkl')
hkl.dump(finalLabel, 'datasetClientsUnion/' + dataName + '/clients_label.hkl')
